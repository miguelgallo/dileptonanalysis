...
if __name__ == '__main__':
   ...
   #config.General.requestName = 'DYToMuMu_M-50-RunIISummer19UL17-preTS2'
   #config.JobType.psetName = 'RunGGLL_UL_MC_cfg_preTS2.py'
   #config.JobType.inputFiles = ['../proton_simulation_validation/settings/2017_preTS2/direct_simu_reco_cff.py','PUHistos_data.root','PUHistos_mc.root']
   ...
   config.General.requestName = 'GGToMuMu_Pt-25_Inel-Inel-RunIISummer19UL17-preTS2'
   config.JobType.psetName = 'RunGGLL_UL_MC_cfg_preTS2.py'
   config.JobType.inputFiles = ['../proton_simulation_validation/settings/2017_preTS2/direct_simu_reco_cff.py','PUHistos_data.root','PUHistos_mc.root']
   ...
   #config.General.requestName = 'GGToMuMu_Pt-25_Inel-El-RunIISummer19UL17-preTS2'
   #config.JobType.psetName = 'RunGGLL_UL_MC_cfg_preTS2.py'
   #config.JobType.inputFiles = ['../proton_simulation_validation/settings/2017_preTS2/direct_simu_reco_cff.py','PUHistos_data.root','PUHistos_mc.root']
   #config.Data.unitsPerJob = 6200
   ...
   #config.General.requestName = 'GGToMuMu_Pt-25_Elastic-RunIISummer19UL17-preTS2'
   #config.JobType.psetName = 'RunGGLL_UL_MC_cfg_preTS2.py'
   #config.JobType.inputFiles = ['../proton_simulation_validation/settings/2017_preTS2/direct_simu_reco_cff.py','PUHistos_data.root','PUHistos_mc.root']
   #config.Data.unitsPerJob = 6200
