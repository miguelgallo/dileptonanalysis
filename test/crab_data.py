...
#config.JobType.psetName = 'RunGGLL_UL_dataEG_cfg.py'
...
config.Data.lumiMask = '/home/malvesga/Ntuple_build/CMSSW_10_6_20/src/test/json_file_cms_2017.txt'
...
if __name__ == '__main__':
   ...
   config.JobType.inputFiles = ['PUHistos_data.root']
   ...
   config.Data.outLFNDirBase = '/store/user/malvesga/miniaod/DoubleMuon_Data_UL2017C'
   submit(config)
   ...
   config.Data.outLFNDirBase = '/store/user/malvesga/miniaod/DoubleMuon_Data_UL2017F'
   submit(config)
   
   config.General.requestName = 'DoubleMuon_Data_UL2017G'
   config.JobType.inputFiles = ['PUHistos_data.root']
   config.Data.inputDataset = '/DoubleMuon/Run2017G-09Aug2019_UL2017-v1/MINIAOD'
   config.Data.outLFNDirBase = '/store/user/malvesga/miniaod/DoubleMuon_Data_UL2017G'
   submit(config)
