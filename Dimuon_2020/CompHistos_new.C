...
int CompHistos_new()
{
   ...
   TFile *f_dy = new TFile("histos_MC/output_dy_UL.root", "READ");
   TFile *f_dy_resample = new TFile("histos_MC/output_dy_UL_resample.root", "READ");
   TFile *f_data = new TFile("histos_data/output_data_UL_limitRun.root", "READ");
   TFile *f_elastic_mixpu = new TFile("histos_MC/output_exclusive_mixpu.root", "READ");
   TFile *f_inel_el_mixpu = new TFile("histos_MC/output_semi-exclusive_mixpu.root", "READ");
   ...
   //double n_events_pileup = 68709480.;
   ...
   double scale_factor_dy_cutflow = ((68709480./79827976.)*limit_lumi*5334000) / n_events_h_dy; 
   double est = ((68709480./79827976.)*limit_lumi*5334000) / ( n_events_h_dy*number_of_samples ) ; 
   ...
   for (int i = 0; i < Nhist; i++) {
      ...
      if( (i >= 0 && i <= 8) ||  (i >= 47 && i <= 49) ){
         ...
         event_selection = 68709480./79827976.; //Used on the pile-up protons mixing
         //event_selection = 1; //Used on the pile-up protons mixing
      }   
      ...
      TH1 *h_elastic_x100 = 0; f_elastic->GetObject(hist[i], h_elastic_x100);
      TH1 *h_elastic_x110 = 0; f_elastic->GetObject(hist[i], h_elastic_x110);
      TH1 *h_elastic_x120 = 0; f_elastic->GetObject(hist[i], h_elastic_x120);
      TH1 *h_elastic_x130 = 0; f_elastic->GetObject(hist[i], h_elastic_x130);
      TH1 *h_elastic_x140 = 0; f_elastic->GetObject(hist[i], h_elastic_x140);
      TH1 *h_elastic_x150 = 0; f_elastic->GetObject(hist[i], h_elastic_x150);
      TH1 *h_inel_el_signal = 0; f_inel_el->GetObject(hist[i], h_inel_el_signal);
      TH1 *h_inel_el_x100 = 0; f_inel_el->GetObject(hist[i], h_inel_el_x100);
      TH1 *h_inel_el_x110 = 0; f_inel_el->GetObject(hist[i], h_inel_el_x110);
      TH1 *h_inel_el_x120 = 0; f_inel_el->GetObject(hist[i], h_inel_el_x120);
      TH1 *h_inel_el_x130 = 0; f_inel_el->GetObject(hist[i], h_inel_el_x130);
      TH1 *h_inel_el_x140 = 0; f_inel_el->GetObject(hist[i], h_inel_el_x140);
      TH1 *h_inel_el_x150 = 0; f_inel_el->GetObject(hist[i], h_inel_el_x150);
   ...
   for (int i = 0; i < Nmultiplicity; i++) {
      ...
      TH1 *h_elastic_x100_0prot = 0; f_elastic->GetObject(hist_multiplicity[i], h_elastic_x100_0prot);
      TH1 *h_elastic_x110_0prot = 0; f_elastic->GetObject(hist_multiplicity[i], h_elastic_x110_0prot);
      TH1 *h_elastic_x120_0prot = 0; f_elastic->GetObject(hist_multiplicity[i], h_elastic_x120_0prot);
      TH1 *h_elastic_x130_0prot = 0; f_elastic->GetObject(hist_multiplicity[i], h_elastic_x130_0prot);
      TH1 *h_elastic_x140_0prot = 0; f_elastic->GetObject(hist_multiplicity[i], h_elastic_x140_0prot);
      TH1 *h_elastic_x150_0prot = 0; f_elastic->GetObject(hist_multiplicity[i], h_elastic_x150_0prot);
      TH1 *h_inel_el_signal_0prot = 0; f_inel_el->GetObject(hist_multiplicity[i], h_inel_el_signal_0prot);
      TH1 *h_inel_el_x100_0prot = 0; f_inel_el->GetObject(hist_multiplicity[i], h_inel_el_x100_0prot);
      TH1 *h_inel_el_x110_0prot = 0; f_inel_el->GetObject(hist_multiplicity[i], h_inel_el_x110_0prot);
      TH1 *h_inel_el_x120_0prot = 0; f_inel_el->GetObject(hist_multiplicity[i], h_inel_el_x120_0prot);
      TH1 *h_inel_el_x130_0prot = 0; f_inel_el->GetObject(hist_multiplicity[i], h_inel_el_x130_0prot);
      TH1 *h_inel_el_x140_0prot = 0; f_inel_el->GetObject(hist_multiplicity[i], h_inel_el_x140_0prot);
      TH1 *h_inel_el_x150_0prot = 0; f_inel_el->GetObject(hist_multiplicity[i], h_inel_el_x150_0prot);
