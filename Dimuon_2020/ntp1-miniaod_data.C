...
void ntp1::Loop()
{
   ...
   TH1D *proton_xi_left_rp23_match_1 = new TH1D("proton_xi_left_rp23_match_1", "#xi Proton Left - Match - RP 23", nbins_single_left1, bins_single_left1);
   TH1D *proton_xi_left_rp23_match_2 = new TH1D("proton_xi_left_rp23_match_2", "#xi Proton Left - Match - RP 23", nbins_single_left2, bins_single_left2);
   ...
   TH1D *proton_xi_left_rp23_nprot_match_1 = new TH1D("proton_xi_left_rp23_nprot_match_1", "#xi Proton Left - Match - RP 23", nbins_single_left1, bins_single_left1);
   TH1D *proton_xi_left_rp23_nprot_match_2 = new TH1D("proton_xi_left_rp23_nprot_match_2", "#xi Proton Left - Match - RP 23", nbins_single_left2, bins_single_left2);
   ...
   TH1D *proton_xi_right_rp123_match_1 = new TH1D("proton_xi_right_rp123_match_1", "#xi Proton Right - Match - RP 123", nbins_single_right1, bins_single_right1);
   TH1D *proton_xi_right_rp123_match_2 = new TH1D("proton_xi_right_rp123_match_2", "#xi Proton Right - Match - RP 123", nbins_single_right2, bins_single_right2);
   ...
   TH1D *proton_xi_right_rp123_nprot_match_1 = new TH1D("proton_xi_right_rp123_nprot_match_1", "#xi Proton Right - Match - RP 123", nbins_single_right1, bins_single_right1);
   TH1D *proton_xi_right_rp123_nprot_match_2 = new TH1D("proton_xi_right_rp123_nprot_match_2", "#xi Proton Right - Match - RP 123", nbins_single_right2, bins_single_right2);
   ...
   TH1D *proton_xi_left_multi_match_1_multitrack = new TH1D("proton_xi_left_multi_match_1_multitrack", "#xi Proton Left - Match - Multi RP", nbins_1, bins_1);
   TH1D *proton_xi_left_multi_match_2_multitrack = new TH1D("proton_xi_left_multi_match_2_multitrack", "#xi Proton Left - Match - Multi RP", nbins_2, bins_2);
   TH1D *proton_xi_left_multi_match_1_strips = new TH1D("proton_xi_left_multi_match_1_strips", "#xi Proton Left - Match - Multi RP", nbins_1, bins_1);
   TH1D *proton_xi_left_multi_match_2_strips = new TH1D("proton_xi_left_multi_match_2_strips", "#xi Proton Left - Match - Multi RP", nbins_2, bins_2);
   TH1D *proton_xi_left_multi_match_1 = new TH1D("proton_xi_left_multi_match_1", "#xi Proton Left - Match - Multi RP", nbins_1, bins_1);
   TH1D *proton_xi_left_multi_match_2 = new TH1D("proton_xi_left_multi_match_2", "#xi Proton Left - Match - Multi RP", nbins_2, bins_2);
   ...
   TH1D *proton_xi_right_multi_match_1_multitrack = new TH1D("proton_xi_right_multi_match_1_multitrack", "#xi Proton Right - Match - Multi RP", nbins_1, bins_1);
   TH1D *proton_xi_right_multi_match_2_multitrack = new TH1D("proton_xi_right_multi_match_2_multitrack", "#xi Proton Right - Match - Multi RP", nbins_2, bins_2);
   TH1D *proton_xi_right_multi_match_1_strips = new TH1D("proton_xi_right_multi_match_1_strips", "#xi Proton Right - Match - Multi RP", nbins_1, bins_1);
   TH1D *proton_xi_right_multi_match_2_strips = new TH1D("proton_xi_right_multi_match_2_strips", "#xi Proton Right - Match - Multi RP", nbins_2, bins_2);
   TH1D *proton_xi_right_multi_match_1 = new TH1D("proton_xi_right_multi_match_1", "#xi Proton Right - Match - Multi RP", nbins_1, bins_1);
   TH1D *proton_xi_right_multi_match_2 = new TH1D("proton_xi_right_multi_match_2", "#xi Proton Right - Match - Multi RP", nbins_2, bins_2);
   ...
   //number of reconstructed protons before and after plane shifts
   double cont_before_trackpixshift_single = 0;
   double cont_after_trackpixshift_single = 0;
   double cont_before_trackpixshift_multi = 0;
   double cont_after_trackpixshift_multi = 0;
                        ...
                        if(a < 0.009){
                           ...
                           if(contador_ext_PV3 <= 3){
                              ...
                              for ( unsigned int idx = 0; idx < nRecoProtCand; ++idx ) {
                                 ...
                                 cont_before_trackpixshift_single++;
                                 if (ProtCand_trackpixshift_single[idx] == 0) {    
                                    cont_after_trackpixshift_single++;
                                    //left side - single RP        
                                    if(fid_45) {
                                       //RP 3 
                                             ...
                                             if (ProtCand_trackthx_single[idx] < .02 && ProtCand_trackthy_single[idx] < .02) {
                                                ...
                                                if ( sigma_xi_RP3 > 0.) {
                                                   ...
                                                   if ( TMath::Abs( ProtCand_xi[idx] - xi_pair_left_reco ) <= n_sigmas_xi*sigma_xi_rp3_mumu ) {
                                                      match = true;
                                                      corte_match_rp3++;
                                                      proton_xi_left_rp3_match_1->Fill(ProtCand_xi[idx]);
                                                      proton_xi_left_rp3_match_2->Fill(ProtCand_xi[idx]);
                                             ...
                                             if (ProtCand_trackthx_single[idx] < .02 && ProtCand_trackthy_single[idx] < .02) {
                                                ...
                                                if ( sigma_xi_RP23_nprot > 0.) {
                                                   ...
                                                   if ( TMath::Abs( ProtCand_xi[idx] - xi_pair_left_reco ) <= n_sigmas_xi*sigma_xi_rp23_nprot_mumu ) {
                                                      ...
                                                      proton_xi_left_rp23_nprot_match_1->Fill(ProtCand_xi[idx]);
                                                      proton_xi_left_rp23_nprot_match_2->Fill(ProtCand_xi[idx]);
                                             ...
                                             if (ProtCand_trackthx_multi2[idx] < .02 && ProtCand_trackthy_multi2[idx] < .02) {
                                                ...
                                                if ( sigma_xi_RP103 > 0.) {
                                                   ...
                                                   if ( TMath::Abs( ProtCand_xi[idx] - xi_pair_right_reco ) <= n_sigmas_xi*sigma_xi_rp103_mumu ) {
                                                      match = true;
                                                      corte_match_rp103++;
                                                      proton_xi_right_rp103_match_1->Fill(ProtCand_xi[idx]);
                                                      proton_xi_right_rp103_match_2->Fill(ProtCand_xi[idx]);
                                             ...
                                             if (ProtCand_trackthx_multi2[idx] < .02 && ProtCand_trackthy_multi2[idx] < .02) {
                                                ...
                                                if ( sigma_xi_RP123_nprot > 0.) {
                                                   ...
                                                   if ( TMath::Abs( ProtCand_xi[idx] - xi_pair_right_reco ) <= n_sigmas_xi*sigma_xi_rp123_nprot_mumu ) { 
                                                      ...
                                                      proton_xi_right_rp123_nprot_match_1->Fill(ProtCand_xi[idx]);
                                                      proton_xi_right_rp123_nprot_match_2->Fill(ProtCand_xi[idx]);
                                             ...
                                             if (ProtCand_trackthx_multi2[idx] < .02 && ProtCand_trackthy_multi2[idx] < .02) {
                                                ...
                                                if ( sigma_xi_left_multi > 0.) {
                                                   ...
                                                   if ( TMath::Abs( ProtCand_xi[idx] - xi_pair_left_reco ) <= n_sigmas_xi*sigma_xi_lm_mumu ) { 
                                                      ...
                                                      proton_xi_left_multi_match_1_multitrack->Fill(ProtCand_xi[idx]);
                                                      proton_xi_left_multi_match_2_multitrack->Fill(ProtCand_xi[idx]);
                                                      proton_xi_left_multi_match_1_strips->Fill(ProtCand_xi[idx]);
                                                      proton_xi_left_multi_match_2_strips->Fill(ProtCand_xi[idx]);
                                                      proton_xi_left_multi_match_1->Fill(ProtCand_xi[idx]);
                                                      proton_xi_left_multi_match_2->Fill(ProtCand_xi[idx]);
                                             ...
                                             if (ProtCand_trackthx_multi2[idx] < .02 && ProtCand_trackthy_multi2[idx] < .02) {
                                                ...
                                                if ( sigma_xi_right_multi > 0.) {
                                                   ...
                                                   if ( TMath::Abs( ProtCand_xi[idx] - xi_pair_right_reco ) <= n_sigmas_xi*sigma_xi_rm_mumu ) {
                                                      ...
                                                      proton_xi_right_multi_match_1_multitrack->Fill(ProtCand_xi[idx]);
                                                      proton_xi_right_multi_match_2_multitrack->Fill(ProtCand_xi[idx]);
                                                      proton_xi_right_multi_match_1_strips->Fill(ProtCand_xi[idx]);
                                                      proton_xi_right_multi_match_2_strips->Fill(ProtCand_xi[idx]);
                                                      proton_xi_right_multi_match_1->Fill(ProtCand_xi[idx]);
                                                      proton_xi_right_multi_match_2->Fill(ProtCand_xi[idx]);
                              ...
                              if (cont_single_rp23==1 && fid_45_1prot){
                                 ...
                                 if ( sigma_xi_left_rp23 > 0.) {
                                    ...
                                    if ( TMath::Abs( single_rp23_xi - xi_pair_left_reco ) <= n_sigmas_xi*sigma_xi_rp23_mumu ) {
                                       ...
                                       proton_xi_left_rp23_match_1->Fill(single_rp23_xi);
                                       proton_xi_left_rp23_match_2->Fill(single_rp23_xi);
                              ...
                              if (cont_single_rp123==1 && fid_56_1prot){
                                 ...
                                 if ( sigma_xi_right_rp123 > 0.) {
                                    ...
                                    if ( TMath::Abs( single_rp123_xi - xi_pair_right_reco ) <= n_sigmas_xi*sigma_xi_rp123_mumu ) {
                                       ...
                                       proton_xi_right_rp123_match_1->Fill(single_rp123_xi);
                                       proton_xi_right_rp123_match_2->Fill(single_rp123_xi);
   ...
   cout << "Razao trackpixshift single: " << cont_after_trackpixshift_single/cont_before_trackpixshift_single << endl;
   cout << "Razao trackpixshift multi: " << cont_after_trackpixshift_multi/cont_before_trackpixshift_multi << endl;
