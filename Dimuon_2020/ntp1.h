...
class ntp1 {
   public :
      ...
      Float_t         ProtCand_time[19];   //[nRecoProtCand]
      ...
      Int_t           ProtCand_trackpixshift_single[19];   //[nRecoProtCand]
      Int_t           ProtCand_trackpixshift_multi1[19];   //[nRecoProtCand]
      Int_t           ProtCand_trackpixshift_multi2[19];   //[nRecoProtCand]
      Double_t        ProtCand_trackreducedchi2_single[19];   //[nRecoProtCand]
      Double_t        ProtCand_trackreducedchi2_multi1[19];   //[nRecoProtCand]
      Double_t        ProtCand_trackreducedchi2_multi2[19];   //[nRecoProtCand]
      Double_t        ProtCand_trackthx_single[19];   //[nRecoProtCand]
      Double_t        ProtCand_trackthx_multi1[19];   //[nRecoProtCand]
      Double_t        ProtCand_trackthy_single[19];   //[nRecoProtCand]
      Double_t        ProtCand_trackthy_multi1[19];   //[nRecoProtCand]
      Double_t        ProtCand_trackthx_multi2[19];   //[nRecoProtCand]
      Double_t        ProtCand_trackthy_multi2[19];   //[nRecoProtCand]
      Int_t           ProtCand_trackndof_single[19];   //[nRecoProtCand]
      Int_t           ProtCand_trackndof_multi1[19];   //[nRecoProtCand]
      Int_t           ProtCand_trackndof_multi2[19];   //[nRecoProtCand]
      ...
      ntp1(TTree *tree=0);
      ntp1(std::string const&, std::string const&, std::string const&, TTree *tree=0);
      virtual ~ntp1();
...
#endif
#ifdef ntp1_cxx
ntp1::ntp1(std::string const& fileName_, std::string const& outfileName_, std::string const& era_, TTree *tree) : fChain(0), threeplusthree(false), fileName(fileName_), outfileName(outfileName_), era(era_)
{
...
ntp1::ntp1(TTree *tree) : ntp1("input.root", "output_cut.root", "all", tree) {}
