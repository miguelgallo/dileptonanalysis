...
void ntp1::Loop()
{
   ...
   //reweighting factor
   TFile *input_re;
   if (era == "all" && !threeplusthree) input_re = new TFile("/eos/user/m/malvesga/miniaod/from_analysis/etc/outof3+3_pol_re.root", "READ");
   if (era == "all" && threeplusthree) input_re = new TFile("/eos/user/m/malvesga/miniaod/from_analysis/etc/3+3_pol_re.root", "READ");
   if (era == "B" && !threeplusthree) input_re = new TFile("/eos/user/m/malvesga/miniaod/from_analysis/etc/eraB_pol_re.root", "READ");
   if (era == "C1" && !threeplusthree) input_re = new TFile("/eos/user/m/malvesga/miniaod/from_analysis/etc/eraC1_pol_re.root", "READ");
   if (era == "C2" && threeplusthree) input_re = new TFile("/eos/user/m/malvesga/miniaod/from_analysis/etc/eraC2_pol_re.root", "READ");
   if (era == "D" && threeplusthree) input_re = new TFile("/eos/user/m/malvesga/miniaod/from_analysis/etc/eraD_pol_re.root", "READ");
   if (era == "E" && !threeplusthree) input_re = new TFile("/eos/user/m/malvesga/miniaod/from_analysis/etc/eraE_pol_re.root", "READ");
   if (era == "F1" && !threeplusthree) input_re = new TFile("/eos/user/m/malvesga/miniaod/from_analysis/etc/eraF1_pol_re.root", "READ");
   if (era == "F2" && threeplusthree) input_re = new TFile("/eos/user/m/malvesga/miniaod/from_analysis/etc/eraF2_pol_re.root", "READ");
   if (era == "F3" && threeplusthree) input_re = new TFile("/eos/user/m/malvesga/miniaod/from_analysis/etc/eraF3_pol_re.root", "READ");
   ...
   //ttree loop with proton pileup mixing
                                             ...
                                             if (ProtCand_trackthx_multi2[idx] < .02 && ProtCand_trackthy_multi2[idx] < .02) {
                                                ...
                                                if ( sigma_xi_left_multi > 0.) {
                                                   ...
                                                   if ( TMath::Abs( ProtCand_xi[idx] - xi_pair_left_reco ) <= n_sigmas_xi*sigma_xi_lm_mumu ) { 
                                                      ...
                                                      proton_xi_left_multi_match_1_multitrack->Fill(ProtCand_xi[idx], weight);
                                                      proton_xi_left_multi_match_2_multitrack->Fill(ProtCand_xi[idx], weight);
                                                      proton_xi_left_multi_match_1_strips->Fill(ProtCand_xi[idx], weight);
                                                      proton_xi_left_multi_match_2_strips->Fill(ProtCand_xi[idx], weight);
                                             ...
                                             if (ProtCand_trackthx_multi2[idx] < .02 && ProtCand_trackthy_multi2[idx] < .02) {
                                                ...
                                                if ( sigma_xi_right_multi > 0.) {
                                                   ...
                                                   if ( TMath::Abs( ProtCand_xi[idx] - xi_pair_right_reco ) <= n_sigmas_xi*sigma_xi_rm_mumu ) {
                                                      ...
                                                      proton_xi_right_multi_match_1_multitrack->Fill(ProtCand_xi[idx], weight);
                                                      proton_xi_right_multi_match_2_multitrack->Fill(ProtCand_xi[idx], weight);
                                                      proton_xi_right_multi_match_1_strips->Fill(ProtCand_xi[idx], weight);
                                                      proton_xi_right_multi_match_2_strips->Fill(ProtCand_xi[idx], weight);
...
int run(std::string fileName="input.root", std::string fileNamePileUp="input.root", std::string outfileName="output_cut.root", std::string era="all", bool resample=false, unsigned int number_of_samples=-1, bool reweighting=false, bool threeplusthree=false) {
   ntp1 m( fileName, fileNamePileUp, outfileName, era );
