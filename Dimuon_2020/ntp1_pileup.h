...
class ntp1 {
   public :
      ...
      Int_t           ProtCand_trackpixshift_single[NMAXPROTONS];   //[nRecoProtCand]
      Int_t           ProtCand_trackpixshift_multi1[NMAXPROTONS];   //[nRecoProtCand]
      Int_t           ProtCand_trackpixshift_multi2[NMAXPROTONS];   //[nRecoProtCand]
      Double_t        ProtCand_trackreducedchi2_single[NMAXPROTONS];   //[nRecoProtCand]
      Double_t        ProtCand_trackreducedchi2_multi1[NMAXPROTONS];   //[nRecoProtCand]
      Double_t        ProtCand_trackreducedchi2_multi2[NMAXPROTONS];   //[nRecoProtCand]
      Double_t        ProtCand_trackthx_single[NMAXPROTONS];   //[nRecoProtCand]
      Double_t        ProtCand_trackthx_multi1[NMAXPROTONS];   //[nRecoProtCand]
      Double_t        ProtCand_trackthy_single[NMAXPROTONS];   //[nRecoProtCand]
      Double_t        ProtCand_trackthy_multi1[NMAXPROTONS];   //[nRecoProtCand]
      Double_t        ProtCand_trackthx_multi2[NMAXPROTONS];   //[nRecoProtCand]
      Double_t        ProtCand_trackthy_multi2[NMAXPROTONS];   //[nRecoProtCand]
      Int_t           ProtCand_trackndof_single[NMAXPROTONS];   //[nRecoProtCand]
      Int_t           ProtCand_trackndof_multi1[NMAXPROTONS];   //[nRecoProtCand]
      Int_t           ProtCand_trackndof_multi2[NMAXPROTONS];   //[nRecoProtCand]
      ...
      TBranch        *b_ProtCand_trackpixshift_single;   //!
      TBranch        *b_ProtCand_trackpixshift_multi1;   //!
      TBranch        *b_ProtCand_trackpixshift_multi2;   //!
      TBranch        *b_ProtCand_trackreducedchi2_single;   //!
      TBranch        *b_ProtCand_trackreducedchi2_multi1;   //!
      TBranch        *b_ProtCand_trackreducedchi2_multi2;   //!
      TBranch        *b_ProtCand_trackthx_single;   //!
      TBranch        *b_ProtCand_trackthx_multi1;   //!
      TBranch        *b_ProtCand_trackthy_single;   //!
      TBranch        *b_ProtCand_trackthy_multi1;   //!
      TBranch        *b_ProtCand_trackthx_multi2;   //!
      TBranch        *b_ProtCand_trackthy_multi2;   //!
      TBranch        *b_ProtCand_trackndof_single;   //!
      TBranch        *b_ProtCand_trackndof_multi1;   //!
      TBranch        *b_ProtCand_trackndof_multi2;   //!
      ...
      TBranch        *b_MixProtCand_trackpixshift_single;   //!
      TBranch        *b_MixProtCand_trackpixshift_multi1;   //!
      TBranch        *b_MixProtCand_trackpixshift_multi2;   //!
      TBranch        *b_MixProtCand_trackreducedchi2_single;   //!
      TBranch        *b_MixProtCand_trackreducedchi2_multi1;   //!
      TBranch        *b_MixProtCand_trackreducedchi2_multi2;   //!
      TBranch        *b_MixProtCand_trackthx_single;   //!
      TBranch        *b_MixProtCand_trackthx_multi1;   //!
      TBranch        *b_MixProtCand_trackthy_single;   //!
      TBranch        *b_MixProtCand_trackthy_multi1;   //!
      TBranch        *b_MixProtCand_trackthx_multi2;   //!
      TBranch        *b_MixProtCand_trackthy_multi2;   //!
      TBranch        *b_MixProtCand_trackndof_single;   //!
      TBranch        *b_MixProtCand_trackndof_multi1;   //!
      TBranch        *b_MixProtCand_trackndof_multi2;   //!

      ntp1(TTree *tree=0);
      ntp1(std::string const&, std::string const&, std::string const&, std::string const&, TTree *tree=0);
      virtual ~ntp1();
      ...
      virtual void     SetThreePlusThree(bool);
...
#ifdef ntp1_cxx
ntp1::ntp1(std::string const& fileName_, std::string const& fileNamePileUp_, std::string const& outfileName_, std::string const& era_, TTree *tree) : fChain(0), resample(false), resample_number(-1), reweighting(false), threeplusthree(false), fileName(fileName_), fileNamePileUp(fileNamePileUp_), outfileName(outfileName_), era(era_)
{
   ...
   //fileNamePileUp = "/mnt/hadoop/cms/store/user/malvesga/pileup/pileup_protons_DoubleMuon_3+3.root";
...
ntp1::ntp1(TTree *tree) : ntp1("input.root", "input.root", "output_cut.root", "all", tree) {}
...
void ntp1::SetThreePlusThree(bool flag_3) { threeplusthree = flag_3; }
...
void ntp1::Init(TTree *tree)
{
   ...
   if( !mix_pileup ){
      ...
      //fChain->SetBranchAddress("ProtCand_trackpixshift1", ProtCand_trackpixshift1, &b_ProtCand_trackpixshift1);
      //fChain->SetBranchAddress("ProtCand_trackpixshift2", ProtCand_trackpixshift2, &b_ProtCand_trackpixshift2);
      fChain->SetBranchAddress("ProtCand_trackpixshift_single", ProtCand_trackpixshift_single, &b_ProtCand_trackpixshift_single);
      fChain->SetBranchAddress("ProtCand_trackpixshift_multi1", ProtCand_trackpixshift_multi1, &b_ProtCand_trackpixshift_multi1);
      fChain->SetBranchAddress("ProtCand_trackpixshift_multi2", ProtCand_trackpixshift_multi2, &b_ProtCand_trackpixshift_multi2);
      fChain->SetBranchAddress("ProtCand_trackreducedchi2_single", ProtCand_trackreducedchi2_single, &b_ProtCand_trackreducedchi2_single);
      fChain->SetBranchAddress("ProtCand_trackreducedchi2_multi1", ProtCand_trackreducedchi2_multi1, &b_ProtCand_trackreducedchi2_multi1);
      fChain->SetBranchAddress("ProtCand_trackreducedchi2_multi2", ProtCand_trackreducedchi2_multi2, &b_ProtCand_trackreducedchi2_multi2);
      fChain->SetBranchAddress("ProtCand_trackthx_single", ProtCand_trackthx_single, &b_ProtCand_trackthx_single);
      fChain->SetBranchAddress("ProtCand_trackthx_multi1", ProtCand_trackthx_multi1, &b_ProtCand_trackthx_multi1);
      fChain->SetBranchAddress("ProtCand_trackthy_single", ProtCand_trackthy_single, &b_ProtCand_trackthy_single);
      fChain->SetBranchAddress("ProtCand_trackthy_multi1", ProtCand_trackthy_multi1, &b_ProtCand_trackthy_multi1);
      fChain->SetBranchAddress("ProtCand_trackthx_multi2", ProtCand_trackthx_multi2, &b_ProtCand_trackthx_multi2);
      fChain->SetBranchAddress("ProtCand_trackthy_multi2", ProtCand_trackthy_multi2, &b_ProtCand_trackthy_multi2);
      fChain->SetBranchAddress("ProtCand_trackndof_single", ProtCand_trackndof_single, &b_ProtCand_trackndof_single);
      fChain->SetBranchAddress("ProtCand_trackndof_multi1", ProtCand_trackndof_multi1, &b_ProtCand_trackndof_multi1);
      fChain->SetBranchAddress("ProtCand_trackndof_multi2", ProtCand_trackndof_multi2, &b_ProtCand_trackndof_multi2);
   } else {
      ...
      pileup_tree->SetBranchAddress("ProtCand_trackpixshift_single", ProtCand_trackpixshift_single, &b_MixProtCand_trackpixshift_single);
      pileup_tree->SetBranchAddress("ProtCand_trackpixshift_multi1", ProtCand_trackpixshift_multi1, &b_MixProtCand_trackpixshift_multi1);
      pileup_tree->SetBranchAddress("ProtCand_trackpixshift_multi2", ProtCand_trackpixshift_multi2, &b_MixProtCand_trackpixshift_multi2);
      pileup_tree->SetBranchAddress("ProtCand_trackreducedchi2_single", ProtCand_trackreducedchi2_single, &b_MixProtCand_trackreducedchi2_single);
      pileup_tree->SetBranchAddress("ProtCand_trackreducedchi2_multi1", ProtCand_trackreducedchi2_multi1, &b_MixProtCand_trackreducedchi2_multi1);
      pileup_tree->SetBranchAddress("ProtCand_trackreducedchi2_multi2", ProtCand_trackreducedchi2_multi2, &b_MixProtCand_trackreducedchi2_multi2);
      pileup_tree->SetBranchAddress("ProtCand_trackthx_single", ProtCand_trackthx_single, &b_MixProtCand_trackthx_single);
      pileup_tree->SetBranchAddress("ProtCand_trackthx_multi1", ProtCand_trackthx_multi1, &b_MixProtCand_trackthx_multi1);
      pileup_tree->SetBranchAddress("ProtCand_trackthy_single", ProtCand_trackthy_single, &b_MixProtCand_trackthy_single);
      pileup_tree->SetBranchAddress("ProtCand_trackthy_multi1", ProtCand_trackthy_multi1, &b_MixProtCand_trackthy_multi1);
      pileup_tree->SetBranchAddress("ProtCand_trackthx_multi2", ProtCand_trackthx_multi2, &b_MixProtCand_trackthx_multi2);
      pileup_tree->SetBranchAddress("ProtCand_trackthy_multi2", ProtCand_trackthy_multi2, &b_MixProtCand_trackthy_multi2);
      pileup_tree->SetBranchAddress("ProtCand_trackndof_single", ProtCand_trackndof_single, &b_MixProtCand_trackndof_single);
      pileup_tree->SetBranchAddress("ProtCand_trackndof_multi1", ProtCand_trackndof_multi1, &b_MixProtCand_trackndof_multi1);
      pileup_tree->SetBranchAddress("ProtCand_trackndof_multi2", ProtCand_trackndof_multi2, &b_MixProtCand_trackndof_multi2);
   }
}
